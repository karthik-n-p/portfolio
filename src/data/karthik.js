...
export const skills = [
  ...
  },
  {
    ...
    items: ['Apache Spark', 'Databricks', 'Hadoop', 'Kafka', 'HDFS'],
    color: '#0af5a0',
  ...
  },
  {
    ...
    items: ['ETL Development', 'Data Warehousing', 'Streaming Pipelines', 'Data Modeling', 'dbt', 'Alteryx'],
    color: '#f59e0b',
  ...
  },
  {
    id: 'databases',
    category: 'Databases',
    items: ['MongoDB', 'Azure SQL', 'Delta Lake', 'IBM DB2', 'Snowflake'],
    color: '#8b5cf6',
  ...
  },
  {
    ...
    items: ['Azure ADF', 'Azure Synapse', 'Databricks', 'Blob Storage'],
    color: '#f43f5e',
